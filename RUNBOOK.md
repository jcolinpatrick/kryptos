...
Go to https://internal.com/workbench/ and test interactively.
...
```bash
sudo systemctl status internal-api.service    # Check if running
sudo systemctl restart internal-api.service    # Restart after code changes
sudo journalctl -u internal-api -f             # Tail live logs
```
