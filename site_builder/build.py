#!/usr/bin/env python3
"""Build the internal.com static site from databases, docs, and templates."""
...
def build():
    ...
    print("=" * 60)
    print("internal.com — Static Site Build")
    print("=" * 60)
    ...
    _build_standalone_viewer(
        ...
        title="Polybius Grid Walk — internal.com",
    ...
    _build_standalone_viewer(
        ...
        title="K3 Jefferson Viewer — internal.com",
