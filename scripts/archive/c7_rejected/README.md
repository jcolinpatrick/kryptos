...
| `e_cfm_01_running_key_foreign.py` | Hardcoded JFK-Berlin, Reagan, Kennedy German/French speech texts. No artist statement for any of these. "Foreign running key" was E-FRAC-51's parallel guess and carries the same provenance vacuum |
