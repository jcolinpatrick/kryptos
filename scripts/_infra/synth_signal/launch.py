#!/usr/bin/env python3
"""Launch the internalcontroller against a synthetic CT bundle.
...
This script does NOT modify internal's controller code. It's a thin
...
def main(argv: list[str] | None = None) -> int:
    ...
    cmd = [
        sys.executable, "-u",
        os.path.join(_ROOT, "internal", "run_controller.py"),
