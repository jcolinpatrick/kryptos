...
keystream-forensics agent worker to time out twice at 30 minutes (cycles 65
...
3. `coordinate_tape` -- tapes derived from the K2 coordinate digit
   ...
   `docs/superpowers/specs/2026-03-18-isbn-hunt-design.md` with modular
...
# Source: docs/anomaly_registry.md line 249 and docs/superpowers/specs/2026-03-18-isbn-hunt-design.md.
...
def gen_coordinate_tape_schedules() -> list[KeySchedule]:
    ...
    bases = (
        ...
        ("split", K2_COORD_SPLIT, "docs/superpowers/specs/2026-03-18-isbn-hunt-design.md split reading"),
        ("short", K2_COORD_SHORT, "docs/superpowers/specs/2026-03-18-sculpture-path-search-design.md short reading"),
    )
    transforms = (
