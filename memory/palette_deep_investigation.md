# Palette {B,G,I,K,O,W,Z} Deep Investigation — 2026-03-15
...
3. The BC keystream enrichment strongly supports Beaufort as the cipher
   variant. The first 8 key letters at BCL are almost all palette letters,
   suggesting the key generation process and the null-insertion process
