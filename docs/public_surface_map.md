...
| Home page (internal.com) | `ops/site_builder/templates/home.html` | Generally safe; "ruled out" in hero is acceptable; findings preview cards are cautious; "not a claim" disclaimer is strong | OK |
