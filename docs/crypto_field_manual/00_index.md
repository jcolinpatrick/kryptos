...
**Purpose:** A durable, historically grounded cryptographic knowledge base focused on pencil-and-paper methods, built to raise internal's baseline competence and translate domain knowledge into falsifiable K4 research hypotheses.

**Audience:** internal(Claude Code agents working on Kryptos K4) and the human lead.
