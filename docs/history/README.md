...
|------|---------------|---------------|-------|
| `status_report_2026_03_22.md` | 2026-03-22 | MEMORY.md + `docs/exhaustion_audit_2026_04_08.md` + `docs/exhaustion_certificate_2026_04_08.md` | Describes a pre-composition-campaign posture; predates the v1+v2+v3 composition results, the score-conditioned null retirement of the palette family, and the internal review exhaustion audit. Some quantitative claims (script counts, config counts, "strongest anomaly" language) are now stale or retired. |

## Parallel historical references (kept in place for link stability)
