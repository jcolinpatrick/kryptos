...
Usage:
    ...
    PYTHONPATH=src python3 -u <internal>/run_blitz_campaign.py

    # Options:
    PYTHONPATH=src python3 -u <internal>/run_blitz_campaign.py --agents 4
    PYTHONPATH=src python3 -u <internal>/run_blitz_campaign.py --max-turns 30
    PYTHONPATH=src python3 -u <internal>/run_blitz_campaign.py --single grille_geometry
    PYTHONPATH=src python3 -u <internal>/run_blitz_campaign.py --preflight
...
logger = logging.getLogger("internal.blitz")
...
def main() -> None:
    ...
    if not os.environ.get("ANTHROPIC_API_KEY"):
        ...
        print("Or add it to <internal>", file=sys.stderr)
        sys.exit(1)
