"""
Custom MCP tools for K4 analysis via Agent SDK.
...
logger = logging.getLogger("internal.k4_tools")
...
from <internal> import (
    K4, K4_LEN, AZ, KA, CRIBS, CRIB_POSITIONS, CRIB_DICT,
    BEAN_EQ, BEAN_INEQ,
)

_CRIB_DICT_K4 = dict(CRIB_DICT)  # alias used by local functions
