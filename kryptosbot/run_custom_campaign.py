...
from internal.config import KryptosBotConfig, Strategy, StrategyCategory
...
FRAMEWORK_INTEGRATION = Strategy(
    ...
    prompt_template=(
        ...
        "Known: BERLIN at positions 64-69, CLOCK at 70-74.\n\n"
...
DOUBLE_TRANSPOSITION = Strategy(
    ...
    prompt_template=(
        "Kryptos K4 ciphertext: {ciphertext}\n"
        "Known: BERLINCLOCK at positions 64-74.\n\n"
        ...
        "   reversed, those characters must land at positions 64-74\n"
...
DISPROVE_BIFID = Strategy(
    ...
    prompt_template=(
        ...
        "4. For each, verify against BERLINCLOCK crib at positions 64-74\n"
