...
Usage:
    ...
    PYTHONPATH=src python3 -u <internal>/campaign.py --budget 50
    PYTHONPATH=src python3 -u <internal>/campaign.py --local-only
    PYTHONPATH=src python3 -u <internal>/campaign.py --dry-run
    PYTHONPATH=src python3 -u <internal>/campaign.py --phase bean    # Bean phases only
    PYTHONPATH=src python3 -u <internal>/campaign.py --phase null    # Null-mask SA only
"""
    ...
    *,
    ...
    if not local_only:
        ...
        if not api_key:
            ...
            print("  Set key in environment or <internal> for API-guided search.")
            local_only = True
        else:
