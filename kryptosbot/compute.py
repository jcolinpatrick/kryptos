...
# ---------------------------------------------------------------------------
# Constants — imported from canonical source (kryptos.kernel.constants)
# ---------------------------------------------------------------------------

from kryptosbot.constants import K4, K4_LEN, AZ, KA, CRIBS, CRIB_DICT, BEAN_EQ, BEAN_INEQ
...
KRYPTOS_ALPHABET = KA  # alias for backward compat
...
# Bean constraints — imported from canonical source
_BEAN_EQ = BEAN_EQ
_BEAN_INEQ = tuple(BEAN_INEQ)
...
# Canonical K1-K3 plaintext.
# CORRECTED 2026-08-25. The previous block in this position carried a
# FABRICATED K3 plaintext ("...THATLAYATTHEBOTTOMOFTHESTAIRCASE...",
# "ATFIRSTICOULDNTSEEANYTHING") with five INVENTED X separators. It was the
# last of three K3_PT bindings in this file, so it shadowed the others and was
# the one exported in SPLIT_TEXT_SOURCES and folded into K123_PT.
# K3 is a keyed double columnar TRANSPOSITION, so its plaintext must be an
...
K2_PT = (
    ...
    "THEINFORMATIONWASGATHEREDANDTRANSMITTEDUNDERGRUUNDTOANUNKNOWNLOCATIO"
    "NXDOESLANGLEYKNOWABOUTTHISTHEYSHOULDITSBURIEDOUTTHERESOMEWHEREXWHOKN"
    "OWSTHEEXACTLOCATIONONLYWWTHISWASHISLASTMESSAGEXTHIRTYEIGHTDEGREESFIF"
    "TYSEVENMINUTESSIXPOINTFIVESECONDSNORTHSEVENTYSEVENDEGREESEIGHTMINUTE"
    "SFORTYFOURSECONDSWESTIDBYROWS"
)
K3_PT = (
    "SLOWLYDESPARATLYSLOWLYTHEREMAINSOFPASSAGEDEBRISTHATENCUMBEREDTHELOWE"
    "RPARTOFTHEDOORWAYWASREMOVEDWITHTREMBLINGHANDSIMADEATINYBREACHINTHEUP"
    "PERLEFTHANDCORNERANDTHENWIDENINGTHEHOLEALITTLEIINSERTEDTHECANDLEANDP"
    "EEREDINTHEHOTAIRESCAPINGFROMTHECHAMBERCAUSEDTHEFLAMETOFLICKERBUTPRES"
    "ENTLYDETAILSOFTHEROOMWITHINEMERGEDFROMTHEMISTXCANYOUSEEANYTHINGQ"
)

# K1-K3 ciphertext (alpha only, from the sculpture)
K1_CT = "EMUFPHZLRFAXYUSDJKZLDKRNSHGNFIVJYQTQUXQBQVYUVLLTREVJYQTMKYRDMFD"
K3_CT = (
    "ENDYAHROHNLSRHEOCPTEOIBIDYSHNAIACHTNREYULDSLLSLLNOHSNOSMRWXMNETPRNGA"
    "TIHNRARPESLNNELEBLPIIACAEWMTWNDITEENRAHCTENEUDRETNHAEOETFOLSEDTIWENH"
    "AEIOYTEYQHEENCTAYCREIFTBRSPAMHHEWENATAMATEGYEERLBTEEFOASFIOTUETUAEOT"
    "OARMAEERTNRTIBSEDDNIAAHTTMSTEWPIEROAGRIEWFEBAECTDDHILCEIHSITEGOEAOSD"
    "DRYDLORITRKLMLEHAGTDHARDPNEOHMGFMFEUHEECDMRIPFEIMEHNLSSTTRTVDOHW"
)
