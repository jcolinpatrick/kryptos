...
logger = logging.getLogger("internal.hypothesis_tester")
...
from <internal> import (
    K4, K4_LEN, KA, AZ, CRIBS, CRIB_DICT, CRIB_POSITIONS,
    BEAN_EQ, BEAN_INEQ,
)
...
# Bean constraints — imported from canonical source above
_CRIB_DICT = dict(CRIB_DICT)  # mutable alias for local use
...
def _load_quadgrams() -> dict[str, float]:
    ...
    _module_dir = Path(__file__).resolve().parent.parent.parent  # <internal>/<internal>/ -> kryptos/
    candidates = [
