"""
Constants bridge — single import point for internalmodules.
...
Usage:
    from <internal> import CT, CRIB_DICT, BEAN_EQ, BEAN_INEQ
"""
...
# Convenience aliases matching names used across internalmodules
K4 = CT
K4_LEN = CT_LEN
AZ = ALPH
KA = KRYPTOS_ALPHABET
