...
Usage:
    PYTHONPATH=src python3 -u <internal>/horologe_deep.py
    PYTHONPATH=src python3 -u <internal>/horologe_deep.py --local-only
    PYTHONPATH=src python3 -u <internal>/horologe_deep.py --phase gromark
    PYTHONPATH=src python3 -u <internal>/horologe_deep.py --phase sa
    PYTHONPATH=src python3 -u <internal>/horologe_deep.py --phase agent
"""
...
logger = logging.getLogger("internal.horologe_deep")
...
async def run_agent_investigation(
    ...
    *,
    ...
    from internal.agent_runner import run_agent_session, AgentResult
