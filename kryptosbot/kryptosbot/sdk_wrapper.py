"""
Wrapper for the Agent SDK query() function.
...
logger = logging.getLogger("internal.sdk_wrapper")
...
_ERROR_PATTERNS: list[tuple[str, str, str]] = [
    ...
    ("fatal error in message reader", "PROTOCOL_MISMATCH",
     ...
     "agent-sdk and claude CLI. Run: pip install --upgrade agent-sdk"),
]
...
async def preflight_check() -> tuple[bool, str]:
    """
    Verify that the Agent SDK can spawn a working session.
