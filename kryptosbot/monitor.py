...
def main() -> None:
    ...
    if campaign_dir is None or not campaign_dir.exists():
        ...
        print(f"Run a campaign first: python3 <internal>/solve.py")
        print(f"Or specify a directory: python3 <internal>/monitor.py --campaign results/campaigns/YYYYMMDD_HHMMSS")
        sys.exit(1)
