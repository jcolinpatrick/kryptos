...
Usage:
    PYTHONPATH=src python3 -u <internal>/campaign_v2.py
    PYTHONPATH=src python3 -u <internal>/campaign_v2.py --budget 250
    PYTHONPATH=src python3 -u <internal>/campaign_v2.py --local-only
    PYTHONPATH=src python3 -u <internal>/campaign_v2.py --dry-run
    PYTHONPATH=src python3 -u <internal>/campaign_v2.py --phase row_key
"""
...
from internal.polybius_scorer import (
...
logger = logging.getLogger("internal.campaign_v2")
...
def _print_summary(state: CampaignV2State) -> None:
    ...
    print(f"  Resume: PYTHONPATH=src python3 -u <internal>/campaign_v2.py")
    print(f"{'=' * 70}\n")
