...
# Ensure internalpackage is importable
sys.path.insert(0, str(Path(__file__).resolve().parent))

from internal.agent_runner import AgentResult, TokenTracker, run_agent_session
from internal.strategies import (
    STRATEGIES,
    Strategy,
    StrategyMode,
    build_prompt,
...
logger = logging.getLogger("internal.solve")
...
async def run_preflight() -> bool:
    ...
    try:
        ...
        print("  Install with: pip install agent-sdk")
        return False
...
def main() -> None:
    ...
    if args.command == "compute":
        ...
        if phase == "gromark":
            ...
            print("Use: python3 <internal>/horologe_deep.py --phase agent")
        else:
