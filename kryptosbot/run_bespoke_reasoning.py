...
Usage:
  cd internal&& python run_bespoke_reasoning.py
...
logger = logging.getLogger("internal.bespoke")
...
Write your analysis to <internal>/kbot_results/bespoke_cipher_design.md
...
Write your analysis to <internal>/kbot_results/ckm_hand_cipher.md
...
Write your analysis to <internal>/kbot_results/two_systems_analysis.md
...
Write your analysis to <internal>/kbot_results/receiver_identity.md
...
async def run_agent(name: str, config: dict, project_root: Path) -> dict:
    ...
    from internal.sdk_wrapper import safe_query
    ...
    # Save raw output
    raw_path = project_root / "internal" / "kbot_results" / f"{name}_raw.txt"
...
async def main():
    ...
    summary_path = project_root / "internal" / "kbot_results" / "bespoke_campaign_summary.json"
