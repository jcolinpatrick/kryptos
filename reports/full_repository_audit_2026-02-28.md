...
|-----------|------|------|--------|
| API server | `api/` | 60K | RUNNING (systemd, FastAPI + Haiku classifier for internal.com) |
...
| `api/` | Theory classifier for internal.com | **ACTIVE** | systemd service running, 43 MB RAM, port 8321 |
