---
status: HISTORICAL SNAPSHOT — kept in place for link stability
snapshot_date: 2026-02-20
superseded_by: MEMORY.md + docs/exhaustion_certificate_2026_04_08.md
reason: Pre-dates composition campaigns v1/v2/v3, the 2026-04-01 claims audit, the palette-family retirement, and the Team of Rivals exhaustion audit. The elimination landscape it describes is historical.
---

> # HISTORICAL SNAPSHOT — NOT CURRENT DOCTRINE
>
> This file is heavily cross-linked from other docs and is kept at its
> original path for link stability. **It is not current doctrine.** For
> the live elimination landscape run the session briefing and read
> `docs/elimination_tiers.md`, `docs/exhaustion_certificate_2026_04_08.md`,
> and `MEMORY.md`. See `docs/history/README.md` for the historical index.
...
- **0 genuine signals within tested cipher families and parameter ranges** (all scores within noise at discriminating periods)
