...
**Date:** 2026-02-21
**Based on:** E-FRAC-33, 34, 35, 36, 39, 40, 40b, 41, 42, 43, 44
**Status:** FINAL — all discriminator experiments converged + information-theoretic analysis
...
6. **Information-theoretic proof (E-FRAC-44):** Arbitrary permutation search is provably underdetermined. The 24 cribs provide 113 bits against a 505-bit target (22%). Even with all constraints (Bean + English), a 138-bit deficit remains (~2^138 consistent permutations). Structured transposition families reduce the search space to ~2^18, making the oracle sufficient. This is why structured family search works but arbitrary SA does not.

---

*Generated by agent_frac, 2026-02-21. Based on 44 experiments.*
